...
enum ImGuiToastType_
{
	...
	ImGuiToastType_Enabled,
	ImGuiToastType_Disabled
};
...
private:
	...
	NOTIFY_INLINE auto set_title(const char* format, va_list args) { vsnprintf_s(this->title, sizeof(this->title), format, args); }

	NOTIFY_INLINE auto set_content(const char* format, va_list args) { vsnprintf_s(this->content, sizeof(this->content), format, args); }
	...
	NOTIFY_INLINE auto get_default_title() -> char*
	{
		if (!strlen(this->title))
		{
			...
			case ImGuiToastType_Info:
				return (char*)"Info";
			case ImGuiToastType_Enabled:
				return (char*)"Enabled";
			case ImGuiToastType_Disabled:
