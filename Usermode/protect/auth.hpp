...
namespace KeyAuth {
	...
	public:
		...
		std::string სახელი, მესაკუთრე, საიდუმლო, ვერსია, ბმული;

		api(std::string name, std::string ownerid, std::string secret, std::string version, std::string url) : სახელი(name), მესაკუთრე(ownerid), საიდუმლო(secret), ვერსია(version), ბმული(url) {}
